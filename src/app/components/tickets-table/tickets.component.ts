...
export class TicketsComponent {
  ...
  // sortTicketsByOldest() {
  //   this.ticketService.getAllTicketsByOldest(sessionStorage.getItem('app.username')).subscribe(data => {
  //     this.dataSource.data = data;
  //     this.sharedService.refresh = false;
  //     this.sharedService.blockOnLiveButton = true;
  //   }, error => {
  ...
  changeRefreshSettingAfterOpenSpecificTicket() {
    this.sortTicketsByNewest()
  }
